...
mod parse_size {
    ...
    use crate::{api::message::{fields::{FieldId, FieldKind, FieldSize, FieldSyn}, message::{Message, MessageParse}, message_kind::MessageKind, parse_id::ParseId, parse_kind::ParseKind, parse_size::ParseSize, parse_syn::ParseSyn}, debug::dbg_id::DbgId};
    ///
    ///
    ...
    fn parse() {
        ...
        let mut parse_size = ParseSize::new(
            &dbgid,
            FieldSize(4),
            ParseKind::new(
                &dbgid,
